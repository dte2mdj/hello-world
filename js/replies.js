...
(function () {
  ...
  const topics = [
    ...
    {
      id: "blame",
      keys: ["甩锅", "背锅", "锅你背", "责任推", "栽赃", "背黑锅", "甩给你"],
      lines: [
        "「{w}」鉴定完毕：锅从天上来，别伸手接。功成而弗居，何况别人的锅。",
        "关于「{w}」——出事前「一起扛」，出事时「怎么是你」：这不是复盘，是嫁祸。",
        "「{w}」已退回原主。曲则全：先留边界，再谈谁的责任。",
        "接到「{w}」。好说话不是原罪，别让它变成无限背锅许可证。",
      ],
    },
    {
      id: "monday",
