...
const scams = [
  ...
  },
  {
    ...
    id: "simple",
    tag: "需求黑洞",
    verdict: "简单两个字背后，常是无限返工。先问边界、验收和排期——没边界的简单，是复杂的伪装。",
    img: "https://images.unsplash.com/photo-1553877522-43269d4ea984?auto=format&fit=crop&w=800&h=450&q=80",
    credit: "Photo: Unsplash",
  },
  {
    title: "「你看看人家小王」",
    id: "compare",
    tag: "对比打击",
    verdict: "小王有小王的命数，你有你的节奏。拿别人当尺子量你，多半是在偷懒激励。知人者智，也知己。",
    img: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=800&h=450&q=80",
    credit: "Photo: Unsplash",
  },
  {
    title: "「周末加个班不影响」",
    id: "weekend",
    tag: "侵占休息",
    verdict: "影响的是你的命，不是他的排期。休息不是福利，是续命。知止不殆：止得住周末，才守得住周一。",
    img: "https://images.unsplash.com/photo-1506784983877-45594efa4cbe?auto=format&fit=crop&w=800&h=450&q=80",
    credit: "Photo: Unsplash",
  },
  {
    title: "「你记一下会议纪要哈」",
    id: "minutes",
    tag: "隐形杂役",
    verdict: "永远让同一个人记纪要，不是信任，是分工不公。会推，也是一种无为。轮值才叫团队。",
    img: "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&w=800&h=450&q=80",
    credit: "Photo: Unsplash",
  },
  {
    title: "「试用期再观察观察」",
    id: "probation",
    tag: "无限延期",
    verdict: "观察可以，无限观察就是免费用工。约定期限、书面标准；含糊的「再看看」，多半在耗你的耐心。",
    img: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=800&h=450&q=80",
    credit: "Photo: Unsplash",
  },
  {
    ...
    id: "gaslight",
    tag: "改口洗脑",
    verdict: "没记下来的「说好了」，最容易被改口。邮件、纪要、复述确认——不是较真，是护道。",
    img: "https://images.unsplash.com/photo-1432888498266-38ffec3eaf0a?auto=format&fit=crop&w=800&h=450&q=80",
    credit: "Photo: Unsplash",
  },
  {
    title: "「你情商要提高」",
    id: "eq",
    tag: "边界抹杀",
    verdict: "不同意不合理要求，不叫低情商。叫你提高情商的人，常常在降低你的边界。柔弱胜刚强，不等于无底线。",
    img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=800&h=450&q=80",
    credit: "Photo: Unsplash",
  },
  {
    title: "「免费给你曝光」",
    id: "exposure",
    tag: "白嫖包装",
    verdict: "曝光不能当房租。用曝光换劳动的，多半在贩卖你的时间。先问：谁付钱，付多少。",
    img: "https://images.unsplash.com/photo-1611162616475-46b635cb4953?auto=format&fit=crop&w=800&h=450&q=80",
    credit: "Photo: Unsplash",
  },
  {
    title: "「借我周转一下」",
    id: "lend",
    tag: "人情借贷",
    verdict: "真周转不怕字据，假周转最怕清醒。借钱看能力，不看情分；情分还不起时，连朋友一起没。",
    img: "https://images.unsplash.com/photo-1580519542036-c47de6196ba5?auto=format&fit=crop&w=800&h=450&q=80",
    credit: "Photo: Unsplash",
  },
  {
    title: "「对齐一下颗粒度」",
    id: "jargon",
    tag: "黑话迷雾",
    verdict: "黑话越满，责任越空。听不懂就问人话版：要做什么、谁负责、何时完。道曰：信言不美，美言不信。",
    img: "https://images.unsplash.com/photo-1551836022-d5d88e9218df?auto=format&fit=crop&w=800&h=450&q=80",
    credit: "Photo: Unsplash",
  },
  {
    title: "「领导说了算」",
    id: "bossays",
    tag: "权威甩锅",
    verdict: "领导说了算，不代表决策不用负责。把权威当挡箭牌时，你更要留痕：执行可以，背锅免谈。",
    img: "https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=800&h=450&q=80",
    credit: "Photo: Unsplash",
  },
  {
    title: "「不是我不帮你，是流程」",
    id: "process",
    tag: "流程挡箭",
    verdict: "流程该挡的是风险，不该挡的是人情里的责任。能通融时装死，要甩锅时搬流程——识破即可。",
    img: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?auto=format&fit=crop&w=800&h=450&q=80",
    credit: "Photo: Unsplash",
  },
  {
    ...
    id: "expect",
    tag: "预期下调",
    verdict: "对齐预期常常是单方面降薪降权的前奏。先对齐书面条件，再谈感觉。轻诺必寡信。",
    img: "https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=800&h=450&q=80",
    credit: "Photo: Unsplash",
  },
  {
    title: "「你还年轻，多锻炼」",
    id: "young",
    tag: "廉价奋斗",
    verdict: "锻炼可以，无偿加班不叫锻炼。年轻不是无限工时的许可证。大器晚成，不靠透支。",
    img: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=800&h=450&q=80",
    credit: "Photo: Unsplash",
  },
];
